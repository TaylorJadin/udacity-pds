...
# works like this
# NEWLIST = [(ITEM OR THING TO DO) (FOR LOOP)]

# conditionals in list comprehensions
squares = [x**2 for x in range(9) if x % 2 == 0]

# works like this
# NEWLIST = [(ITEM OR THING TO DO) (FOR LOOP) (CONDITIONAL)]

# if you need else you have to move the conditional to the beginning of the listcomp, after the expression:
squares = [x**2 if x % 2 == 0 else x + 3 for x in range(9)]

# works like this
# NEWLIST = [(ITEM OR THING TO DO) (CONDITIONAL WITH ELSE) (FOR LOOP)]

#############################################
names = ["Rick Sanchez", "Morty Smith", "Summer Smith", "Jerry Smith", "Beth Smith"]
first_names = [name.split()[0].lower() for name in names] # split and take the forst string in the list
print(first_names)
#############################################
